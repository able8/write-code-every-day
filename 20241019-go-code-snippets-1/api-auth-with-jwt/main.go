...
import (
	...
	form3techJwt "github.com/form3tech-oss/jwt-go"
)

// https://www.golangcode.com/api-auth-with-jwt/
...
func AuthMiddleware(next http.Handler) http.Handler {
	...
	keyFunc := func(token *form3techJwt.Token) (interface{}, error) {
...
curl -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Mjk0MTI2ODksImlhdCI6MTcyOTQwOTA4OSwidXNlciI6Im15dXNlcm5hbWUifQ.LnwzgZKG8KbLMM7ymCErjqjDGJWhr8JX9rY68Ze9Ofg" \
